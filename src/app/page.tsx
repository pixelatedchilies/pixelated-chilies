          ...
          <div className="collapse collapse-arrow border border-slate-700 hover:bg-base-200 transition duration-300">
            ...
            <div className="collapse-content">
              ...
              <p>
                ...
                impactful branding initiatives, we empower businesses to thrive
                in the digital landscape.
              </p>
              <p>
                Dive into our expertise, including crafting engaging funnels,
                optimizing conversion flows, and beyond. With Pixelated Chilies,
                the potential for your online success knows no boundaries.
              </p>
            </div>
          </div>
          <div className="collapse collapse-arrow border border-slate-700 hover:bg-base-200 transition duration-300">
            ...
            <div className="collapse-content">
              ...
              <p>
                ...
                for killer campaigns blending everything from spicy social media
                to fiery content.
              </p>
              <p>
